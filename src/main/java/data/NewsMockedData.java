...
public class NewsMockedData {
    ...
    public NewsMockedData() {
        ...
        news.add(new News(1, "Recycled plastic milk bottles to repave roads in South Africa.",
                "Plastic milk bottles are being recycled to make roads in South Africa, " +
                        ...
                        "Potholes cost the country's road users an estimated $3.4 billion per year in vehicle repairs.", new Date(), "http://localhost:8080/picture/1", LocalDate.of(2019 , Month.SEPTEMBER , 23 ), LocalDate.of( 2018 , Month.SEPTEMBER ,8), new ArrayList<Integer>()));
        news.add(new News(2, "General Electric is weathering a stormy environment better than feared",
                "Prompting the struggling conglomerate to boost its guidance " +
                        ...
                        "The maker of jet engines, MRI machines and light bulbs also stopped burning through cash.", new Date(), "http://localhost:8080/picture/2", LocalDate.of(2019 , Month.SEPTEMBER , 12), LocalDate.of(2019 , Month.DECEMBER, 28 ), new ArrayList<Integer>()));
        news.add(new News(3, "The new maker toolkit: IoT, AI and Google Cloud Platform",
                "Voice interaction is everywhere these days—via phones, TVs, laptops and smart home devices " +
                        ...
                        "and adding voice to their Internet of Things (IoT) projects.", new Date(), "http://localhost:8080/picture/3", LocalDate.of(2019 , Month.SEPTEMBER , 23 ), LocalDate.of(2019 , Month.OCTOBER, 3 ), new ArrayList<Integer>()));
        news.add(new News(4, "De La Rue Plc can’t Stop Losing Money For Its Shareholders",
                "De La Rue Plc shares plummeted again on Wednesday. " +
                        ...
                        "It didn’t provide a reason and a spokesman declined to comment further when contacted by Bloomberg.", new Date(), "http://localhost:8080/picture/4", LocalDate.of(2019 , Month.JULY , 15 ), LocalDate.of(2020 , Month.JANUARY, 18 ), new ArrayList<Integer>()));
        news.add(new News(5, "CEO of Norway’s $1 Trillion Wealth Fund to Resign",
                "The chief executive officer of Norway’s sovereign wealth fund, Yngve Slyngstad, " +
                        "is stepping down after spending the past 12 years building a $1.1 trillion fortune.", new Date(), "http://localhost:8080/picture/5", LocalDate.of(2019 , Month.SEPTEMBER , 20 ), LocalDate.of(2019 , Month.DECEMBER , 2 ), new ArrayList<Integer>()));
    }
    ...
    public News createNews(int id, String title, String content, Date date, String linkToPicture, List<Integer> readStatus) {
        News newsArticle = new News(id, title, content, date, linkToPicture, LocalDate.now(), LocalDate.now(), readStatus);
